...
!H----------------------------------------------------------------------
!H $Id: strtools.F90,v 1.1.1.1 2009/01/12 16:56:08 mariotti Exp $
!H----------------------------------------------------------------------
!H  
...
module strtools
  ...
  interface str_getfrmt
     ...
     module procedure str_getfrmtr !return always F15.8: WARNING
     module procedure str_getfrmtc 
...
!
!H    This routine compare two string and return lilen
...
!
    ...
    !
    lilen = len_trim(str1)
    if(lilen.eq.len_trim(str2)) then
       if(str1(1:lilen).eq.str2(1:lilen)) then
          str_strcmpss = lilen
       else
          str_strcmpss = 0
       endif
