...
!H-----------------------------------------------------------------------------
!H MODULE CSM_MINUIT for Frimol by F.Mariotti: (c) F.Mariotti
!H-----------------------------------------------------------------------------
!H $Id: csm_minuit.F90,v 1.1.1.1 2009/01/12 16:56:08 mariotti Exp $
!H-----------------------------------------------------------------------------
!H
!H DESCRIPTION:
...
1004   format (1x,32x,42hwarning -   - above parameter is at limit.)
       cycle
!
...
!XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
!
  subroutine minuit_getamin(omin)
    !
    real(FREAL), intent(out) :: omin
    !
    omin=amin
    !
  end subroutine minuit_getamin
!
!XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
!
