...
!H-----------------------------------------------------------------------------
!H MODULE FIT1DPOL_MINUIT for Frimol by F.Mariotti
!H-----------------------------------------------------------------------------
!H $Id: fit1Dpol_minuit.F90,v 1.1.1.1 2009/01/12 16:56:08 mariotti Exp $
!H-----------------------------------------------------------------------------
!H
!H DESCRIPTION:
...
!H
!
module fit1dpol_minuit
  !
  use vartypes
  use messages
  use f1dp_minuit_function
  !
  implicit none
  private
  !
  ...
  ! Others
  !-------
  integer(FINT), parameter :: mne=2000
  integer(FINT), parameter :: mni=1000
